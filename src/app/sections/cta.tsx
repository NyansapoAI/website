...
export default function Cta() {
  return (
    <div className="flex overflow-clip relative flex-wrap items-center justify-between w-full max-w-4xl gap-5 mx-auto text-white bg-blue-700 px-7 py-7 lg:px-12 lg:py-12 lg:flex-nowrap rounded-xl">
